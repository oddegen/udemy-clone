...
function CourseReview() {
  ...
  const course = {
    review:
      "This course is amazing! It provides a comprehensive introduction to React and covers all the essential topics in a clear and concise manner.",
    instructor: "John Doe",
    timestamp: Date.now(),
  };
    ...
    <div className="bg-white shadow-md rounded-lg p-6 mb-6 max-w-md mx-auto">
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="flex items-center">
          ...
          <span role="img" aria-label="thumbs-down" className="cursor-pointer">
            👎
          </span>
        </div>
      </div>
